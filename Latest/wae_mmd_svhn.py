...
parser.add_argument('-n_z', type=int, default=16, help='hidden dimension of z (default: 100)')
...
parser.add_argument('-SW_dim', type=int, default=500, help='sliced wasserstein projections(default: 500')
parser.add_argument('-beta1', type=int, default=10, help='sliced wasserstein projections(default: 100')
parser.add_argument('-beta2', type=int, default=10, help='sliced wasserstein projections(default: 100')

args = parser.parse_args()


X_images = get_data('../data/MNIST_SVHN/mnist.npy')
Y_images = get_data('../data/MNIST_SVHN/svhn.npy')
X_images = np.tile(X_images,(1,3,1,1))
print(X_images.shape)
print("Data obtained")
# thetas = generateTheta(args.SW_dim, 100)
encoderX, decoderX = Encoder32(args), Decoder32(args)
#args.n_channel = 3
encoderY, decoderY = Encoder32(args), Decoder32(args)
criterion = nn.MSELoss()
criterion_VGG5 = _VGGDistance(5)
# criterion_VGG4 = _VGGDistance(4)
criterion_VGG3 = _VGGDistance(3)
# criterion_VGG2 = _VGGDistance(2)
print("All initializations done, now to train")
encoderX.train()
decoderX.train()
encoderY.train()
decoderY.train()
...
for epoch in range(args.epochs):
    ...
    # beta_cross = 0.5*np.exp(-epoch/20) + 0.25
    ...
    for i in tqdm(range(batch_n)):
        ...
        # total_loss = recon_loss_x + recon_loss_y + beta*mmd_loss
        total_loss.backward()
        optim.step()
    ...
    if epoch % 2 == 0 :
        # index = np.random.randint(Y_images.shape[0], size=64)
        ...
        with torch.no_grad():
            ...
            # save_image(I_target, 'images/target_%03d.png' % epoch)
